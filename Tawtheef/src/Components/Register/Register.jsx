      ...
      <div className="w-75 mx-auto mt-5 py-4 vh-100 d-flex justify-content-space align-items-center flex-column">
        ...
        <form onSubmit={formic.handleSubmit} className="w-75">
          ...
          {formic.errors.phone && formic.touched.phone ? (
            <div className="alert alert-danger ">{formic.errors.phone}</div>
          ) : null}

          {isloading ? (
            <button type="button" className="btn bg-primary p-2 text-white">
              <i className="fas fa-spinner fa-spin mt-3"></i>
            </button>
          ) : (
            <button
              type="submit"
